...
namespace :'sencha-touch2-charts-rails' do
  JAVASCRIPTS_DIR = 'vendor/assets/javascripts/sencha-touch2-charts-rails'
  STYLESHEETS_DIR = 'vendor/assets/stylesheets/sencha-touch2-charts-rails'
...
Rake.application.tasks_in_scope(%w(sencha-touch2-charts-rails install)).each do |t|
  next if t.name == 'sencha-touch2-charts-rails:install:touch_dir'
  t.prerequisites.unshift 'sencha-touch2-charts-rails:install:touch_dir'
end
